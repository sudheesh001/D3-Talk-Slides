!function () {
  ...
  function Z(n, t) {
    ...
    return [t.clientX - u.left - n.clientLeft,
  ...
  function ft(n, t, r) {
    ...
    e = gt(e) * Ia,
    i = gt(i) * Ya,
    yt(vt(3.2404542 * u - 1.5371385 * e - 0.4985314 * i), vt( - 0.969266 * u + 1.8760108 * e + 0.041556 * i), vt(0.0556434 * u - 0.2040259 * e + 1.0572252 * i))
  }
  function ht(n, t, r) {
  ...
  function bt(n, t, r) {
    ...
    a = o - i,
    c = (o + i) / 2;
    return a ? (u = 0.5 > c ? a / (o + i)  : a / (2 - o - i), e = n == o ? (t - r) / a + (r > t ? 6 : 0)  : t == o ? (r - n) / a + 2 : (n - t) / a + 4, e *= 60)  : (e = 0 / 0, u = c > 0 && 1 > c ? 0 : e),
    et(e, u, c)
  }
  function wt(n, t, r) {
    n = St(n),
  ...
  function Pt(n) {
    ...
    i = e ? function (n) {
      ...
      ], i = 0, o = e[0]; t > 0 && o > 0; ) u.push(n.substring(t -= o, t + o)),
      o = e[i = (i + 1) % e.length];
...
function Ot(n) {
  function t(n) {
    function t(t) {
      for (var r, u, i, o = [
      ], a = - 1, c = 0; ++a < e; ) 37 === n.charCodeAt(a) && (o.push(n.substring(c, a)), null != (u = ic[r = n.charAt(++a)]) && (r = n.charAt(++a)), (i = C[r]) && (r = i(t, null == u ? 'e' === r ? ' ' : '0' : u)), o.push(r), c = a + 1);
...
function Nr(n) {
  if (t = n.length) {
    for (var t, r, e = 0, u = n[0]; ++e < t; ) u.n = r = n[e],
    r.p = u,
    u = r;
    u.n = r = n[0],
    r.p = u
...
function Or(n, t, r, e) {
  ...
  return function (a) {
    function c(n) {
      for (var t = 0, r = d.length, e = n[1], u = 0; r > u; ++u) for (var i, o = 1, a = d[u], c = a.length, s = a[0]; c > o; ++o) i = a[o],
...
function he(n, t) {
  function r(n, t) {
    ...
    s = Math.sin(t),
    l = s * e + a * u;
    return [Math.atan2(c * i - l * o, a * e - s * u),
    G(l * i + c * o)]
  }
  var e = Math.cos(n),
  u = Math.sin(n),
  ...
  return r.invert = function (n, t) {
    ...
    s = Math.sin(t),
    l = s * i - c * o;
    return [Math.atan2(c * i + s * o, a * e + l * u),
    G(l * e - a * u)]
  },
  r
}
function ge(n, t) {
  ...
  return function (u, i, o, a) {
    ...
    for (var s, l = u; o > 0 ? l > i : i > l; l -= c) a.point((s = Mr([r,
    - e * Math.cos(l),
    - e * Math.sin(l)])) [0], s[1])
  }
}
...
function Ee(n, t) {
  return [Math.log(Math.tan(ka / 4 + t / 2)),
  - n]
}
function Ae(n) {
  return n[0]
...
function Xe(n) {
  for (var t, r = $c, e = Fr(n[0][0], n[0][1], n[1][0], n[1][1]), u = r.length; u--; ) t = r[u],
...
function iu(n, t) {
  ...
  i = n.sort(ou).pop();
  for ($c = [
  ], Xc = new Array(n.length), Bc = new nu, Wc = new nu; ; ) if (u = Jc, i && (!u || i.y < u.y || i.y === u.y && i.x < u.x)) (i.x !== r || i.y !== e) && (Xc[i.i] = new Oe(i), je(i), r = i.x, e = i.y),
  i = n.pop();
   else {
    if (!u) break;
    Ue(u.arc)
...
function Iu(n) {
  for (var t = n.source, r = n.target, e = Zu(t, r), u = [
    t
  ]; t !== e; ) t = t.parent,
  u.push(t);
...
function Gu(n, t) {
  for (var r = [
    n
  ]; null != (n = r.pop()); ) if (t(n), (u = n.children) && (e = u.length)) for (var e, u; --e >= 0; ) r.push(u[e])
}
function Ku(n, t) {
  for (var r = [
    n
  ], e = [
  ]; null != (n = r.pop()); ) if (e.push(n), (i = n.children) && (u = i.length)) for (var u, i, o = - 1; ++o < u; ) r.push(i[o]);
...
function Ai(n) {
  for (var t, r = 0, e = 0, u = n.children, i = u.length; --i >= 0; ) t = u[i],
  t.z += r,
  t.m += r,
  r += t.s + (e += t.c)
}
...
function ao(n) {
  function t(t) {
    ...
    ], f = - 1, h = t.length, g = Et(r), p = Et(e); ++f < h; ) u.call(this, c = t[f], f) ? l.push([ + g.call(this, c, f),
...
function lo(n) {
  for (var t = 0, r = n.length, e = n[0], u = [
    ...
    ',',
    e[1]
  ]; ++t < r; ) u.push('H', (e[0] + (e = n[t]) [0]) / 2, 'V', e[1]);
...
function po(n, t) {
  return n.length < 3 ? co(n)  : n[0] + mo((n.push(n[0]), n), yo([n[n.length - 2]].concat(n, [
    n[1]
  ]), t))
}
function vo(n, t) {
...
function yo(n, t) {
  for (var r, e = [
  ], u = (1 - t) / 2, i = n[0], o = n[1], a = 1, c = n.length; ++a < c; ) r = i,
  i = o,
  o = n[a],
  e.push([u * (o[0] - r[0]),
  u * (o[1] - r[1])]);
...
function _o(n) {
  for (var t, r, e = - 1, u = n.length, i = u + 4, o = [
  ], a = [
  ]; ++e < 4; ) r = n[e % u],
  o.push(r[0]),
  a.push(r[1]);
...
function Eo(n) {
  ...
  ], u = n[0], i = n[1], o = e[0] = ko(u, i); ++t < r; ) e[t] = (o + (o = ko(u = i, i = n[t + 1]))) / 2;
  return e[t] = o,
  e
}
function Ao(n) {
  for (var t, r, e, u, i = [
  ], o = Eo(n), a = - 1, c = n.length - 1; ++a < c; ) t = ko(n[a], n[a + 1]),
...
function No(n) {
  for (var t, r, e, u = - 1, i = n.length; ++u < i; ) t = n[u],
  r = t[0],
  e = t[1] + Ms,
  t[0] = r * Math.cos(e),
  t[1] = r * Math.sin(e);
...
function zo(n) {
  function t(t) {
    ...
    ], y = - 1, x = t.length, M = Et(r), _ = Et(u), b = r === e ? function () {
      return g
    }
     : Et(e), w = u === i ? function () {
      return p
    }
     : Et(i); ++y < x; ) o.call(this, h = t[y], y) ? (d.push([g = + M.call(this, h, y),
...
Bo.pairs = function (n) {
  for (var t, r = 0, e = n.length - 1, u = n[0], i = new Array(0 > e ? 0 : e); e > r; ) i[r] = [
    t = u,
    u = n[++r]
  ];
  return i
...
Bo.nest = function () {
  function n(t, a, c) {
    ...
    for (var s, l, f, h, g = - 1, p = a.length, v = i[c++], d = new o; ++g < p; ) (h = d.get(s = v(l = a[g]))) ? h.push(l)  : d.set(s, [
      l
    ]);
...
Bo.behavior.zoom = function () {
  ...
  return n.event = function (n) {
    n.each(function () {
      ...
      As ? Bo.select(this).transition().each('start.zoom', function () {
        ...
        u = r / 2,
        i = e / 2,
        o = Bo.interpolateZoom([(u - S.x) / S.k,
        (i - S.y) / S.k,
        r / S.k], [
          (u - t.x) / t.k,
          (i - t.y) / t.k,
  ...
  n.center = function (t) {
    return arguments.length ? (v = t && [ + t[0],
    + t[1]], n)  : v
  },
  n.size = function (t) {
    return arguments.length ? (k = t && [ + t[0],
    + t[1]], n)  : k
  },
  n.x = function (t) {
...
fc = {
  ...
  MultiPoint: function (n, t) {
    for (var r = n.coordinates, e = - 1, u = r.length; ++e < u; ) n = r[e],
    t.point(n[0], n[1], n[2])
  },
...
Bo.geo.bounds = function () {
  ...
  return function (n) {
    ...
    if (t) {
      ...
      for (var o, r, p = - 1 / 0, t = i.length - 1, e = 0, u = i[t]; t >= e; u = r, ++e) r = i[e],
...
Bo.geo.albers = function () {
  return Bo.geo.conicEqualArea().rotate([96,
  0]).center([ - 0.6,
  38.7]).parallels([29.5,
  45.5]).scale(1070)
},
Bo.geo.albersUsa = function () {
  ...
  u,
  i = Bo.geo.albers(),
  o = Bo.geo.conicEqualArea().rotate([154,
  0]).center([ - 2,
  58.5]).parallels([55,
  65]),
  a = Bo.geo.conicEqualArea().rotate([157,
  0]).center([ - 3,
  19.9]).parallels([8,
  18]),
  c = {
  ...
  n.translate = function (t) {
    ...
    l = + t[0],
    f = + t[1];
    return r = i.translate(t).clipExtent([[l - 0.455 * s,
    f - 0.238 * s],
    [
      l + 0.455 * s,
      f + 0.238 * s
    ]]).stream(c).point,
    e = o.translate([l - 0.307 * s,
    f + 0.201 * s]).clipExtent([[l - 0.425 * s + Ca,
    f + 0.12 * s + Ca],
    [
      l - 0.214 * s - Ca,
      f + 0.234 * s - Ca
    ]]).stream(c).point,
    u = a.translate([l - 0.205 * s,
    f + 0.212 * s]).clipExtent([[l - 0.214 * s + Ca,
    f + 0.166 * s + Ca],
    [
      l - 0.115 * s - Ca,
      f + 0.234 * s - Ca
...
Bo.geom.hull = function (n) {
  function t(n) {
    ...
    + i.call(this, n[t], t),
    t]);
    for (a.sort(ze), t = 0; o > t; t++) c.push([a[t][0],
    - a[t][1]]);
    var s = Ne(a),
    l = Ne(c),
    f = l[0] === s[0],
...
Vc.area = function () {
  for (var n, t = - 1, r = this.length, e = this[r - 1], u = 0; ++t < r; ) n = e,
  e = this[t],
  u += n[1] * e[0] - n[0] * e[1];
  return 0.5 * u
},
...
Oe.prototype.prepare = function () {
  for (var n, t = this.edges, r = t.length; r--; ) n = t[r].edge,
...
Bo.geom.voronoi = function (n) {
  ...
  return n ? t(n)  : (t.links = function (n) {
    ...
    return iu(r(n)).cells.forEach(function (r, e) {
      for (var u, i, o = r.site, a = r.edges.sort(Ye), c = - 1, s = a.length, l = a[s - 1].edge, f = l.l === o ? l.r : l.l; ++c < s; ) u = l,
      i = f,
      l = a[c].edge,
      f = l.l === o ? l.r : l.l,
      e < i.i && e < f.i && au(o, i, f) < 0 && t.push([n[e],
      n[i.i],
      n[f.i]])
    }),
    t
  ...
  function i(n) {
    function i(n, t, r, e, u, i, o, a) {
      if (!isNaN(r) && !isNaN(e)) if (n.leaf) {
        var c = n.x,
        l = n.y;
        if (null != c) if (ca(c - r) + ca(l - e) < 0.01) s(n, t, r, e, u, i, o, a);
         else {
          var f = n.point;
    ...
    ], p = n.length, o) for (g = 0; p > g; ++g) l = n[g],
    l.x < v && (v = l.x),
    l.y < d && (d = l.y),
    l.x > m && (m = l.x),
    l.y > y && (y = l.y),
...
Bo.layout.bundle = function () {
  return function (n) {
    for (var t = [
    ], r = - 1, e = n.length; ++r < e; ) t.push(Iu(n[r]));
    return t
  }
},
...
Bo.layout.force = function () {
  ...
  a.start = function () {
    ...
    isNaN(e.py) && (e.py = e.y);
    if (u = [
    ], 'function' == typeof f) for (t = 0; l > t; ++t) u[t] = + f.call(this, y[t], t);
     else for (t = 0; l > t; ++t) u[t] = f;
    if (i = [
    ], 'function' == typeof h) for (t = 0; l > t; ++t) i[t] = + h.call(this, y[t], t);
...
Bo.layout.histogram = function () {
  function n(n, i) {
    for (var o, a, c = [
    ], s = n.map(r, this), l = e.call(this, s, i), f = u.call(this, l, s, i), i = - 1, h = s.length, g = f.length - 1, p = t ? 1 : 1 / h; ++i < g; ) o = c[i] = [
    ],
    o.dx = f[i + 1] - (o.x = f[i]),
    o.y = 0;
...
Bo.layout.tree = function () {
  ...
  function t(n) {
    for (var t, r = {
      ...
      r
    ]; null != (t = e.pop()); ) for (var u, i = t.children, o = 0, a = i.length; a > o; ++o) e.push((i[o] = u = {
      _: i[o],
      parent: t,
  ...
  function u(n, t, r) {
    if (t) {
      for (var e, u = n, i = n, o = t, c = u.parent.children[0], s = u.m, l = i.m, f = o.m, h = c.m; o = ki(o), u = Si(u), o && u; ) c = Si(c),
      i = ki(i),
      i.a = n,
...
Bo.layout.treemap = function () {
  function n(n, t) {
    for (var r, e, u = - 1, i = n.length; ++u < i; ) e = (r = n[u]).value * (0 > t ? 0 : t),
...
Bo.scale.log = function () {
  return Ji(Bo.scale.linear().domain([0,
  1]), 10, !0, [
    1,
    10
  ])
...
Ls.selectAll = function (n) {
  ...
  for (var c = - 1, s = this.length; ++c < s; ) for (var l = this[c], f = - 1, h = l.length; ++f < h; ) if (e = l[f]) {
    ...
    for (var g = - 1, p = r.length; ++g < p; ) (u = r[g]) && Fo(u, g, o, i),
    t.push(u)
  }
  return Uo(a, o)
},
...
Ls.transition = function () {
  for (var n, t, r, e, u = this.id, i = ++Ts, o = [
  ], a = 0, c = this.length; c > a; a++) {
    o.push(n = [
    ]);
...
function u() {
  ...
  function v() {
    ...
    u = !1;
    M && (n[0] += M[0], n[1] += M[1]),
    C || (Bo.event.altKey ? (x || (x = [
      (l[0] + l[1]) / 2,
      (f[0] + f[1]) / 2
    ]), z[0] = l[ + (n[0] < x[0])], z[1] = f[ + (n[1] < x[1])])  : x = null),
    E && d(n, c, 0) && (r(S), u = !0),
    A && d(n, s, 1) && (e(S), u = !0),
    u && (t(S), w({
      type: 'brush',
